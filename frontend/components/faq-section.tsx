const faqs = [
  ...
  },
  {
    ...
    a: "No. CurieSense AI is a decision-support and research tool. Its outputs are intended to assist qualified clinicians and should never be used as a sole basis for diagnosis or treatment.",
  },
  {
